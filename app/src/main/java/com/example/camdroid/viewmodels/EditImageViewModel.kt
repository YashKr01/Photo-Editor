...
class EditImageViewModel(private val editImageRepository: EditImageRepository) : ViewModel() {
    ...
    private val saveImageFilteredImageDataState = MutableLiveData<SaveFilteredImageDataState>()
    val saveFilteredImageUiState: LiveData<SaveFilteredImageDataState> get() = saveImageFilteredImageDataState
    ...
    private fun emitSaveFilteredImageUiState(
        ...
        saveImageFilteredImageDataState.postValue(dataState)
    }
